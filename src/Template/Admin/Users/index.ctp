...
<div class="table-responsive">
    <table class="table table-striped table-hover">
        ...
        <?php foreach($users as $user) {
            ...
            echo '<td><a class="btn btn-warning" href="'.BASE_URL.'/admin/users/edit/'.$user->id.'">Edit</a></td>';
            echo '<td><a class="delete btn btn-danger" href="'.BASE_URL.'/admin/users/delete/'.$user->id.'">Delete</a></td>';
            echo '</tr>';
        }
        ?>
        </tbody>
